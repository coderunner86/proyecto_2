...
def main():
    ...
    while True:
        ...
        print("4. Mostrar conteo de víctimas por año, mes, departamento, actividad, género, estado")
        print("5. Salir")
        ...
        if option == '1':
            ...
            column_order = ['genero', 'rangoedad', 'estado', 'Actividad', 'condicion', 'grupoetnico',
                            'tipoevento', 'Ubicación', 'municipio', 'departamento', 'sitio', 'latitudcabecera',
                            'longitudcabecera', 'tipoarea', 'ano', 'mes', 'codigodanemunicipio', 'codigodanedepartamento']
            ...
            print(f"Datos filtrados por '{column_name}' = '{value}' exportados a 'data/filtered_by_{column_name}_{value}.csv'.")
